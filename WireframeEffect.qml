            ...
            renderPasses: [
                RenderPass {
                    ...
                    shaderProgram: ShaderProgram {
                        vertexShaderCode:   loadSource("qrc:/shaders/shaders/robustwireframe.vert")
                        geometryShaderCode: loadSource("qrc:/shaders/shaders/robustwireframe.geom")
                        fragmentShaderCode: loadSource("qrc:/shaders/shaders/robustwireframe.frag")
                    }
                }
            ]
        }
