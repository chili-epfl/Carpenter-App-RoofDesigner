...
double calc(Constraint * cons, int consLength)
{
   ...
   for(int i=0;i<consLength;i++)
   {
       ...
       {
           error+= (P1_x - P2_x) * (P1_x - P2_x) + (P1_y - P2_y) * (P1_y - P2_y) - sketchSolveDistance * sketchSolveDistance;

       }

       if(cons[i].type==P2PDistanceVert)
       {
           error+= (P1_y - P2_y) * (P1_y - P2_y) - sketchSolveDistance * sketchSolveDistance;
       }

       if(cons[i].type==P2PDistanceHorz)
       {
           error+= (P1_x - P2_x) * (P1_x - P2_x) - sketchSolveDistance * sketchSolveDistance;
       }
       ...
       if((cons[i]).type==P2LDistance)
       {
           ...
           Xint=L1_P1_x+dx*t;
           Yint=L1_P1_y+dy*t;
           temp= _hypot((P1_x - Xint),(P1_y - Yint)) - sketchSolveDistance;
           error += temp*temp/10;
       ...
       if((cons[i]).type==P2LDistanceVert)
       {
           ...
           t=(P1_x- L1_P1_x)/dx;
           Yint=L1_P1_y+dy*t;
           temp= fabs((P1_y - Yint)) - sketchSolveDistance;
           error += temp*temp;
       ...
       if((cons[i]).type==P2LDistanceHorz)
       {
           ...
           t=(P1_y- L1_P1_y)/dy;
           Xint=L1_P1_x+dx*t;
           temp= fabs((P1_x - Xint)) - sketchSolveDistance;
           error += temp*temp/10;
...
//#if defined(NEWARC)
       ...
       {
           temp= sqrt(pow(L1_P2_x - L1_P1_x,2) + pow(L1_P2_y - L1_P1_y,2)) - sketchSolveLength;
